...
public class OnboardPage {
    ...
    @DrawableRes public int imageBackgroundResourceId;

    public OnboardPage(String title, String description) {
        this.title = title;
        this.description = description;
        this.backgroundColor = R.color.black_transparent;
    }

    public OnboardPage(String title, String description, int imageResourceId) {
        this.title = title;
        this.description = description;
    ...
    public OnboardPage(String title, String description, Drawable imageResource) {
        this.title = title;
        this.description = description;
    ...
    public OnboardPage(int title, int description) {
        this.titleResourceId = title;
        this.descriptionResourceId = description;
        this.backgroundColor = R.color.black_transparent;
    }

    public OnboardPage(int title, int description, int imageResourceId) {
        this.titleResourceId = title;
        this.descriptionResourceId = description;
        this.imageResourceId = imageResourceId;
        this.backgroundColor = R.color.black_transparent;
    ...
    public OnboardPage(int title, int description, Drawable imageResource) {
        this.titleResourceId = title;
        this.descriptionResourceId = description;
        this.imageResource = imageResource;
        this.backgroundColor = R.color.black_transparent;
    ...
    public int getImageBackgroundResourceId() {
        return imageBackgroundResourceId;
    }

    public void setImageBackgroundResourceId(int imageBackgroundResourceId) {
        this.imageBackgroundResourceId = imageBackgroundResourceId;
    }
